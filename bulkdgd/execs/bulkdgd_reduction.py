...
def set_parser(dim_red_name: str) -> argparse.ArgumentParser:
    ...
    # that will be used in the help messages.
    ...
    # Set the default value for the argument.
    cd_default = defaults.CONFIG_FILES_DIM_RED[dim_red_name]
    ...
    # Set the default value for the argument.
    cp_default = defaults.CONFIG_FILES_PLOT[dim_red_name]
    ...
    util.add_wd_and_logging_arguments(\
        parser = parser,
        command_name = f"bulkdgd_reduction_{dim_red_name}")
...
def main(args: argparse.Namespace,
    ...
    try:
        ...
        plotting.plot_dimensionality_reduction(\
            dfs = df_dim_red,
...
def _entry_point(dim_red_name: str) -> None:
    ...
    # Build the parser.
    parser = set_parser(dim_red_name = dim_red_name)
