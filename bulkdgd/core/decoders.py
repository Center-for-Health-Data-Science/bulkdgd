...
def reshape_scaling_factors(x: torch.Tensor,
...
class Decoder(nn.Module):
    ...
    def __init__(self,
        ...
        # Inform the user about the dropout.
        infostr = \
            f"The decoder's dropout fraction was set to {dropout}."
        logger.info(infostr)
    ...
    def _get_output_module(self,
                           ...
                           output_module_name: str,
                           output_module_options: dict[str, object]) \
                            -> outputmodules.OutputModuleBase:
